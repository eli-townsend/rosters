GenerateTeams = {
  ...
  containerTemplate: function() {
    ...
    <button class="delete-team btn btn-dark float-right">Delete <i class="fas fa-trash"></i></button>
    <label>Team Name 
      <input id="team-${ generatedNumber }" type="text" class="team-name-input" required />
    </label>
    <br/><br/>
    <label>Keeper
  ...
  validateContainers: function() {
    // Validation for amount of teams 6-10
